    ...
    <View style={{flex:1}}>
        <View style={{width:'100%',height:'30%'}}>
            <View style={{flexDirection:'row',top:20}}>
                <Image style={{width:150,height:150,resizeMode:'center'}} source ={require('../assets/mobileRed.png')}></Image>
                <View style={{}}>
                    <Text style={{fontSize:20,fontWeight:'500'}}>Điện Thoại Vsmart Joy 3 {'\n'}Hàng chính hãng</Text>
                    <View style={{flexDirection:'row',marginVertical:10}}>
                        <Text style={{fontSize:20,}}>Màu:</Text>
                        <Text style={{fontSize:20,fontWeight:'500'}}>đỏ</Text>
                    </View>
                    <View style={{flexDirection:'row'}}>
                        <Text style={{fontSize:20,}}>Cung cấp bởi:</Text>
                        <Text style={{fontSize:20,fontWeight:'500'}}>Tiki Trading</Text>
                    </View>

                    <Text style={{fontSize:20,fontWeight:'700'}}>1.790.000 đ</Text>
                </View>
            </View>
        </View>
